...
public class CheckWord {
	...
	public static boolean hasInvalidWord(String strData) {
		String strWord = "exec,declare,update,select,delete,insert,truncate,declare";
		if (strData != null) {
			StringTokenizer stringtokenizer = new StringTokenizer(strWord, ",");
			while (stringtokenizer.hasMoreTokens()) {
				if (strData.toLowerCase().indexOf(stringtokenizer.nextToken()) != -1) {
					return true;
				}
			}
		}
	...
	public static boolean isEmpty(String checkString){
		if(checkString == null || "".equals(checkString.trim())) return true;
		return false;
	}
	...
	public static String showMsg(String Msg, String goURL) {
		return "<script language='javascript'  charset='utf-8'>alert('" + Msg
				+ "');location.href='" + goURL + "';</script>";
	}
	...
	public static String get_urlencode_str(String old_str) {
		...
		String new_str = "";
		try {
			new_str = URLEncoder.encode(old_str, "utf-8");
